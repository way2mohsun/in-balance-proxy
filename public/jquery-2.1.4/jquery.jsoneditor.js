...
function getSelected(e) {
    selected = e.value;
    for (var i = 0; i < document.querySelectorAll(".meee").length; i++) {
        document.getElementsByClassName("meee")[i].value = selected;
    }
}
...
(function ($) {
    ...
    function addListAppender(item, handler) {
        ...
        btn.text('Add');
        appender.append(btn).append('\
            <select class="meee" onchange="getSelected(this)">\
