    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        buildDropdownOptions: function () {
            this.$select.children().each(t.proxy(function (e, i) {
                ...
                }, this)), this.options.onChange(o, i), this.updateButtonText(), this.updateSelectAll()
        ...
        updateOptGroups: function () {
            ...
            e.each(function () {
                var e = !0;
                t(this).nextUntil("li.multiselect-group").not(".multiselect-filter-hidden").not(".disabled").each(function () {
                    t("input", this).prop("checked") || (e = !1)
                }), i && (e ? t(this).addClass(i) : t(this).removeClass(i)), t("input", this).prop("checked", e)
            })
        },
